...
<div style="display: flex; justify-content: center; align-items: center; height: 100vh; background-color: black; color: white; text-align: center; flex-direction: column;">
    <h1 style="font-size: 4rem; font-family: Arial, sans-serif;">Your Name</h1>
